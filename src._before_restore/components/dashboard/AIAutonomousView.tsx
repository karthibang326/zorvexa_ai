      ...
      <div className="grid grid-cols-1 xl:grid-cols-2 gap-5">
        <section className="rounded-2xl border border-white/10 bg-[#0B1220] overflow-hidden">
          ...
          <div className="max-h-[420px] overflow-y-auto divide-y divide-white/5">
            {predictions.length === 0 ? (
              <div className="h-40 flex items-center justify-center text-white/35">No predictions yet.</div>
            ) : predictions.map((p) => (
        ...
        <section className="rounded-2xl border border-white/10 bg-[#060a12] overflow-hidden">
          ...
          <div className="p-3 h-[420px] overflow-y-auto font-mono text-[12px]">
            {events.length === 0 ? (
              <div className="h-full flex items-center justify-center text-white/35">Waiting for autonomous stream...</div>
            ) : events.map((e, idx) => (
