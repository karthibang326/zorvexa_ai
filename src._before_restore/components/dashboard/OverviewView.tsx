...
const OverviewView: React.FC = () => {
  ...
  const healthPercent = useMemo(() => (health === "green" ? "99.7%" : health === "yellow" ? "96.2%" : "89.4%"), [health]);
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-4">
        {loadingMetrics ? (
          ...
          <>
            ...
            <MetricCard label="Running Jobs" value="43" hint="Execution layer" />
            <MetricCard label="System Health %" value={healthPercent} tone={health === "green" ? "good" : health === "yellow" ? "warn" : "bad"} />
