    ...
    <div className="space-y-6 pb-8">
      ...
      <section className="rounded-2xl border border-white/10 bg-[#0B1220] overflow-hidden">
        ...
        <div className="divide-y divide-white/5">
          {items.length === 0 ? (
            <div className="h-40 flex items-center justify-center text-white/35">No chaos experiments yet.</div>
          ) : (
            items.map((x) => (
      ...
      <section className="rounded-2xl border border-white/10 bg-[#060a12] overflow-hidden">
        ...
        <div className="p-3 h-[260px] overflow-y-auto font-mono text-[12px]">
          {stream.length === 0 ? (
            <div className="h-full flex items-center justify-center text-white/35">Waiting for chaos/system events...</div>
          ) : (
            stream.map((e) => (
