      ...
      <main className="flex-1 flex items-center justify-center pt-20 px-4">
        ...
        >
          ...
          <p className="text-muted-foreground mb-10 leading-relaxed">
            Thank you. Checkout runs on <strong className="text-foreground">Stripe</strong> (secure, PCI-compliant). Your Pro access activates once the subscription is confirmed.
          </p>
          <Button 
