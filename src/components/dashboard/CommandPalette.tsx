...
import { Bot, Building2, Rocket, Play, Workflow, Activity, AlertTriangle, RotateCcw, Sparkles, Search } from "lucide-react";
...
const CommandPalette: React.FC<CommandPaletteProps> = ({
  ...
  const commands = useMemo<Cmd[]>(() => [
    { id: "nav-tenant", label: "Go to Tenant console", group: "Navigation", shortcut: "G T", icon: <Building2 className="w-4 h-4" />, run: () => onNavigate("tenant-console") },
